...
function App() {
  ...
  const processInput = useCallback(async (inputVal) => {
    ...
    try {
      ...
      let url = 'http://localhost:8000/api/tokenize';
  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <section className="card">
          <h2>Visualization</h2>
          <div className="visualization-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
              ...
              <div className="text-viewer">
                {(typeof visualizedText === 'string' ? visualizedText : '').split('').map((char, index) => {
                  ...
                  const isHighlighted = hoveredTokenIndex !== null &&
                    ...
                    index < tokens[hoveredTokenIndex].end;
            ...
            <div className="token-panel">
              ...
              <div className="token-display">
                {tokens.map((token, index) => {
                  const isHighlighted = hoveredTokenIndex === index;
